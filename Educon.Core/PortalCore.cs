...
namespace Educon.Core
{
    public class PortalCore
    {
        ...
        {
            return FRepository.GetQuestions(AAgeGroup, ANumCategory);
        }
        ...
        public ICollection<Question> GetQuestionListForMatch(string ANamUser1, string ANamUser2, int ANumQuestions)
        {
            ...
            ICollection<Question> LQuestionsOfAgeGroup = FRepository.GetQuestions(LMinAgeGroup, null);
            ...
            ICollection<Question> LNewForOneUserQuestions =
                (from question in LQuestionsOfAgeGroup
                 from userquestion in question.UserQuestions
                 where userquestion.NidUser == LUser1.NidUser || userquestion.NidUser == LUser2.NidUser
                 orderby userquestion.QtdAnswers
                 select question)
                .ToList();
